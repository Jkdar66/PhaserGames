export class Enemies extends Phaser.GameObjects.Container {
    constructor(scene) {
        ...
        this.gridDebug = new Phaser.GameObjects.Grid(scene, 0, 0, column_nums * Enemies.CELL_SIZE, row_nums * Enemies.CELL_SIZE, Enemies.CELL_SIZE, Enemies.CELL_SIZE);
    ...
    move() {
        for (let i = this.children.length - 1; i >= 0; i--) {
            ...
            const outOfEdge = this.scene.game.config.height;
